...
namespace Ophim\ThemeBcco\Controllers;
...
class ThemeBccoController
{
    public function index(Request $request)
    {
        ...
        return view('themes::themebcco.index', [
    ...
    public function getMovieOverview(Request $request, $movie)
    {
        ...
        return view('themes::themebcco.single', [
            'currentMovie' => $movie,
    ...
    public function getEpisode(Request $request, $movie, $slug, $id)
    {
        ...
        return view('themes::themebcco.episode', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'episode' => $episode,
    ...
    public function getMovieOfCategory(Request $request, $slug)
    {
        ...
        $movies = $category->movies()->orderBy('created_at', 'desc')->paginate(24);
    ...
    public function getMovieOfRegion(Request $request, $slug)
    {
        ...
        $movies = $region->movies()->orderBy('created_at', 'desc')->paginate(24);
    ...
    public function getMovieOfActor(Request $request, $slug)
    {
        ...
        $movies = $actor->movies()->orderBy('created_at', 'desc')->paginate(24);
    ...
    public function getMovieOfDirector(Request $request, $slug)
    {
        ...
        $movies = $director->movies()->orderBy('created_at', 'desc')->paginate(24);
    ...
    public function getMovieOfTag(Request $request, $slug)
    {
        ...
        $movies = $tag->movies()->orderBy('created_at', 'desc')->paginate(24);
        return view('themes::themebcco.catalog', [
            'data' => $movies,
            'tag' => $tag,
            'title' => $tag->getTitle(),
    ...
    public function getMovieOfType(Request $request, $slug)
    {
        switch ($slug) {
            case 'phim-de-cu':
                ...
                $movies = Movie::where('is_recommended', 1)->orderBy('created_at', 'desc')->paginate(24);
                break;
            case 'phim-chieu-rap':
                $section_name = 'Phim Chiếu Rạp';
                $movies = Movie::where('is_shown_in_theater', 1)->orderBy('created_at', 'desc')->paginate(24);
                break;
            case 'phim-sap-chieu':
                $section_name = 'Phim Sắp Chiếu';
                $movies = Movie::where('status', 'trailer')->orderBy('created_at', 'desc')->paginate(24);
                break;
            default:
                $type = $slug == 'phim-le' ? 'single' : 'series';
                $section_name = $slug == 'phim-le' ? 'Phim Lẻ' : 'Phim Bộ';
                $movies = Movie::where('type', $type)->orderBy('created_at', 'desc')->paginate(24);
                break;
        }
